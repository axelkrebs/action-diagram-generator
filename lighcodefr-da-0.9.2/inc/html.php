	...
	<body>
		...
		<form id="corps" method="post" action="">
			...
			<div style="float:left;width:49%">
				<p><textarea id="content" cols="" rows="" name="content"><?php if(isset($_POST['content'])) : echo htmlspecialchars(stripcslashes($_POST['content'])); else : echo htmlspecialchars(file_get_contents('exemple.txt')); endif; ?></textarea></p>
			</div>
